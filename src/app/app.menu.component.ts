  ...
  ngOnInit() {
    this.model = [
      ...
      { label: "Armored A-Mail", icon: "email", routerLink: ["/messages"] },
      {
        ...
        items: [
          {
            label: "Cloaked C-Mail",
            icon: "cast_connected",
            routerLink: ["/cloaked"],
          },
          {
            label: "Manage Cloaking Library",
            icon: "cast_connected",
            routerLink: ["/cloakedlibrary"],
          },
          {
            label: "Cloaked Mail Archive",
            icon: "cast_connected",
            routerLink: ["/cloakedarchive"],
          },
        ],
      },
        ...
        items: [
          {
            ...
            command: () => (this.app.layoutCompact = true),
          },
          {
            label: "Large Size",
            icon: "fiber_smart_record",
            command: () => (this.app.layoutCompact = false),
          },
          {
            label: "Vertical Menu",
            icon: "menu",
