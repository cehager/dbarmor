...
export class CloakedLibraryComponent implements OnInit, AfterViewInit {
  ...
  doPost() {
    ...
    this.appRepository.doPostCtxt(this.currentLibItem, this.apiPath).subscribe(
      (data: CText) => {
  ...
  doGetCTxt() {
    ...
    this.apiPath =
      this.appRepository.getApiBasePath() +
      "ctxt/l1/getbytxtid/undo/" +
      this.currentLibItem.txtId;
    ...
    this.appRepository
      .doGetCText(this.currentLibItem.txtId, this.apiPath)
      .subscribe(
        (data: CText) => {
