...
export class DocumentComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    this.items = [
      {
        label: "Create New Document/Story",
        icon: "fa-refresh",
        command: () => {
          this.doCreateNewDoc();
          this.isMsgText = true;
  ...
  doEncrypt() {
    ...
    this.appRepository
      .doEncryptDocument(this.currentDoc, this.apiPath)
      .subscribe(
        (data: Doc) => {
  ...
  doDecrypt() {
    ...
    this.appRepository
      .doDecryptDocument(this.currentDoc, this.apiPath)
      .subscribe(
        (data: Doc) => {
